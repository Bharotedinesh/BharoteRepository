...
public class Xpath4 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		string priceOfHp = driver.findElement(By.xpath("//div[@class='_4rR01T']/ancestor::div[@class='_3pLy-c row']/descendant::div[@class='_30jeq3 _1_WHN1']")).getText();
		System.out.println(priceOfHp);
	}
